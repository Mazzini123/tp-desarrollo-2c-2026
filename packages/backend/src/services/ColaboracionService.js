 ...
 *  3. No puede estar ya anotado (si lo intenta, se rompe: así lo
 *     pidió la cátedra, para que la UI pueda reaccionar).
 *
 * Como la Colaboracion vive dentro del Proyecto, y el Proyecto dentro
 * del Colectivo, al final se persiste el colectivo entero.
 */
export class ColaboracionService {
  ...
  /**
   * Historial de un colaborador. Como las colaboraciones viven dentro
   * de los proyectos, hay que recorrer todos los colectivos y sus
   * proyectos.
   */
